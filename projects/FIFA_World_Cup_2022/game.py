...
class Football(Game):
    ...
    def play(self):
        ...
        if self.points[0] > self.points[1]:
            return [self.team1.team_name,self.points[0],self.team2.team_name,self.points[1]]
        elif self.points[0] < self.points[1]:
            return [self.team2.team_name,self.points[1],self.team1.team_name,self.points[0]]
        else:
            return [([self.team1.team_name,self.points[0]], [self.team2.team_name,self.points[1]])]
    ...
    def select_initial_player_with_ball(self, team : Team):
        att = [player for player in team.players if (player.role == 'F' or player.role == 'M' or player.role == 'D')]
